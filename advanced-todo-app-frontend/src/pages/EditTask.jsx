...
import { creatNewTask, getAllCategories, getTask, updateTask } from '../services/tasksApis';
...
{
  e.preventDefault()
 await updateTask(id,title,description,status,selectedCategory).then((date)=>
  {
    console.log(date)
    navigate('/')
  })
